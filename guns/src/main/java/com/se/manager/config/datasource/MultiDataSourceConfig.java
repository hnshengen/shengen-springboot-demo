 ...
 */
package com.se.manager.config.datasource;
 ...
 */
@Configuration
@ConditionalOnProperty(prefix = "se.muti-datasource", name = "open", havingValue = "true")
@EnableTransactionManagement(order = 2, proxyTargetClass = true)
@MapperScan(basePackages = {"com.se.manager.modular.*.mapper", "com.se.manager.multi.mapper"})
public class MultiDataSourceConfig {
     ...
     */
    @Bean
    @ConfigurationProperties(prefix = "se.muti-datasource")
